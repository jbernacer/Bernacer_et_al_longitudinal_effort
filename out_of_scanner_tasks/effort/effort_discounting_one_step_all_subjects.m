...
for subject=1:length(subjects)
    ...
    effort(first_position:last_position,:)=str2double([input_array_PRE.all_sessions{1,2}; input_array_PRE.all_sessions{2,2}; input_array_POST.all_sessions{1,2}; input_array_POST.all_sessions{2,2}]);
    ...
    LL_all_subs(1,2)=-2*LL_all_subs(1,1)+2*log(5472); %Bayesian Information Criterion (BIC)
    ...
    LL_all_subs(1,4)=-2*LL_all_subs(1,3)+2*log(5472);
    ...
    LL_all_subs(1,6)=-2*LL_all_subs(1,5)+3*log(5472);
    ...
    LL_all_subs(1,8)=-2*LL_all_subs(1,7)+2*log(5472);
