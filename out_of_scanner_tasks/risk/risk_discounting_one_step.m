...
for subject=1:length(subjects)
    ...
    %We have some missing values, significantly intervention subject 15
    %before habit acquisition. Also, 4 subjects in the "control" group.
    ...
    probability=str2double([input_array.all_sessions{1,2}; input_array.all_sessions{2,2}]);
