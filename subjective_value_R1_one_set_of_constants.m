...
for sub=1:length(subjects)
    ...
    subject=sub;
    E_DF(sub,:)=(exp(-beta_dexp.*efforts)+exp(-delta_dexp.*efforts))./2;
    P_DF(sub,:)=exp(-c_risk.*odds_against);
    ...
    matrix_name_1=strcat(pwd,'\fmri\task_logs\',pre_or_post,'_sub_',num2str(subject),'_subjective_value_whole_sample_session_1.mat');
    save(matrix_name_1,'results_matrix_s1');
    matrix_name_2=strcat(pwd,'\fmri\task_logs\',pre_or_post,'_sub_',num2str(subject),'_subjective_value_whole_sample_session_2.mat');
    save(matrix_name_2,'results_matrix_s2');
    matrix_name_3=strcat(pwd,'\fmri\task_logs\',pre_or_post,'_sub_',num2str(subject),'_subjective_value_whole_sample_session_3.mat');
